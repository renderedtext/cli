class Sem::CLI::Teams < Dracula
  ...
  class Members < Dracula
    ...
    def list(team_name)
      ...
      Sem::Views::Teams.list_members(team, team.members)
    end
  ...
  class Projects < Dracula
    ...
    def list(team_name)
      ...
      Sem::Views::Projects.list(team.projects)
    end
  ...
  class SharedConfigs < Dracula
    ...
    def list(team_name)
      ...
      Sem::Views::SharedConfigs.list(team.shared_configs)
    end
